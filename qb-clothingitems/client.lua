...
---- Get Clothe ---- função terminada
--------------------
RegisterNetEvent("jotadateta:client:getclothes2", function(clothe_id, prop)
    local player = PlayerPedId()
    local sex = nil
    --sexo e modelo do ped
    local hash = GetEntityModel(player)
...
RegisterNetEvent("jotadateta:client:getclothes3", function(clothe_id, prop)
    local player = PlayerPedId()
    local sex = nil
    --sexo e modelo do ped
    local hash = GetEntityModel(player)
...
RegisterNetEvent("jotadateta:client:getclothes4", function(clothe_id, prop)
    local player = PlayerPedId()
    local sex = nil
    --sexo e modelo do ped
    local hash = GetEntityModel(player)
